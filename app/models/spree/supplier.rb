class Spree::Supplier < Spree::Base
  ...
  after_create :send_welcome, if: -> { SolidusDropShip::Config[:send_supplier_email] }
  ...
  protected
    ...
    def set_commission
      unless changes.has_key?(:commission_flat_rate)
        self.commission_flat_rate = SolidusDropShip::Config[:default_commission_flat_rate]
      end
      unless changes.has_key?(:commission_percentage)
        self.commission_percentage = SolidusDropShip::Config[:default_commission_percentage]
      end
    end
